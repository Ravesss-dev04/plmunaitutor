    ...
    return (
      <div className="bg-[#13181F] p-6 rounded-xl shadow-sm border border-[#232935] md:w-full md:-ml-0 w-82 -ml-6">
        ...
        <div className="text-center py-4">
          <p className="text-red-400 text-sm mb-2">Failed to load reminders</p>
          <button 
  ...
  return (
    <div className="bg-[#13181F] p-6 rounded-xl shadow-sm border border-[#232935] md:w-full md:-ml-0 w-82 -ml-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-white">Quiz Reminders</h3>
        <button
          onClick={fetchQuizReminders}
      ...
      {reminders.length === 0 ? (
        <div className="text-center py-6">
          ...
          <p className="text-gray-400 text-sm">No upcoming quizzes</p>
          <p className="text-gray-500 text-xs mt-1">New quizzes will appear here</p>
        </div>
      ) : (
        <div className="space-y-4">
          {reminders.map((reminder) => (
            <div 
              key={reminder.id} 
              className="flex items-start space-x-3 p-3 rounded-lg border border-gray-700 hover:border-gray-600 transition-colors cursor-pointer"
