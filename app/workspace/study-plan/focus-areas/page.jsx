    ...
    return (
      <div className="bg-[#161B22] text-white min-h-screen p-4 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-green-400">Loading focus areas...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400">Your current learning priorities</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {focusAreas.length > 0 ? (
            focusAreas.map((area, index) => (
              <div key={index} className="bg-[#1f2937] border border-purple-500/30 rounded-lg p-6 hover:border-purple-500/50 transition-colors">
            ...
            <div className="col-span-2 text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-400 mb-2">No Focus Areas</h3>
              <p className="text-gray-500">Generate a study plan to see your focus areas!</p>
              <button
                onClick={() => router.push('/workspace/study-plan')}
