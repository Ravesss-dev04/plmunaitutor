    ...
    <div className="space-y-4">
      {assignments.map((assignment) => {
        ...
        return (
          <div
            key={assignment.id}
            className="p-4 bg-[#1a1f29] border border-gray-700 rounded-lg hover:border-green-500 transition-colors cursor-pointer"
            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500">
                  {assignment.deadline && (
                    <div className={`flex items-center gap-1 ${isOverdue && !isSubmitted ? 'text-red-400' : ''}`}>
                      <Clock size={14} />
                      <span>
